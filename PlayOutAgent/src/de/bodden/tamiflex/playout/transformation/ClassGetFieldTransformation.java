...
public class ClassGetFieldTransformation extends AbstractClassGetXFieldTransformation {
	
	public ClassGetFieldTransformation() {
		super(new Method("getField", "(Ljava/lang/String;)Ljava/lang/reflect/Field;"));
	}

	@Override
	protected Kind methodKind() {
		return ClassGetField;
	}
